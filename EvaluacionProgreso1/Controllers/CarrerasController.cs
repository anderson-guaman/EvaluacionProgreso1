...
namespace EvaluacionProgreso.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre_Carrera,Campus,Numero_Semestre")] Carrera carrera)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre_Carrera,Campus,Numero_Semestre")] Carrera carrera)
        {
            if (id != carrera.Id)
            {
                return NotFound();
